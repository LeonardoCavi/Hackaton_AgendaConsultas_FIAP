        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InicioDomingo = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    FimDomingo = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    TrabalhaSegunda = table.Column<bool>(type: "BIT", nullable: false),
                    InicioSegunda = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    FimSegunda = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    TrabalhaTerca = table.Column<bool>(type: "BIT", nullable: false),
                    InicioTerca = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    FimTerca = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    TrabalhaQuarta = table.Column<bool>(type: "BIT", nullable: false),
                    InicioQuarta = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    FimQuarta = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    TrabalhaQuinta = table.Column<bool>(type: "BIT", nullable: false),
                    InicioQuinta = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    FimQuinta = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    TrabalhaSexta = table.Column<bool>(type: "BIT", nullable: false),
                    InicioSexta = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    FimSexta = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    TrabalhaSabado = table.Column<bool>(type: "BIT", nullable: false),
                    InicioSabado = table.Column<DateTime>(type: "DATETIME2", nullable: false),
                    FimSabado = table.Column<DateTime>(type: "DATETIME2", nullable: false)
                },
                constraints: table =>
                {
